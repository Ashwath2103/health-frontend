...
export default function CitizenSignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        const abhaId = formData.get("abha") as string;
        ...
        try {
            const data = await authApi.citizenRegister({ name, abhaId, password });
            ...
            <div className={cn("flex flex-col gap-6")}>
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Register with your National Health ID
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSignup}>
                            ...
                            <div className="mt-4 text-center text-sm">
                                ...
                                <Link href="/citizen/login" className="underline underline-offset-4">
                                    Login
                                </Link>
                            </div>
                        </form>
